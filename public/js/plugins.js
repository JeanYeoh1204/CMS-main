    ...
    var a = t(window).width(),
      ...
      P = function () {
        o.children.each(function () {
          ...
          void 0 != e &&
            ('' + e).length &&
            t(this).append('<div class="bx-caption"><span>' + e + '</span></div>');
        });
      },
      y = function (t) {
      ...
      Z = function () {
        var e = t(window).width(),
          i = t(window).height();
        (a != e || l != i) &&
          ((a = e), (l = i), r.redrawSlider(), o.settings.onSliderResize.call(r, o.active.index));
      };
    return (
        ...
        if (!o.working && o.active.index != e)
          if (
            ...
            'next' == i
              ...
              : 'prev' == i &&
                o.settings.onSlidePrev(o.children.eq(o.active.index), o.oldIndex, o.active.index),
...
(function (C, z, f, r) {
  ...
  f.extend(b, {
        ...
        c.helpers &&
          f.each(c.helpers, function (d, e) {
            e &&
              ...
              ((e = f.extend(!0, {}, b.helpers[d].defaults, e)), b.helpers[d][a](e, c));
          });
    ...
    _setDimension: function () {
      ...
      if (h.fitToView)
        if (
          (g.width(c).height(j), e.width(c + y), (a = e.width()), (p = e.height()), h.aspectRatio)
        )
      ...
      init: function (d) {
        (b = a.extend(
          ...
          a(document).click(function (b) {
            return a(b.target).closest('.crf-sm.opened, .crf-s.opened').length > 0
              ? !1
              : (c(), void 0);
          }),
          ...
          this.not('.hided-s').each(function (c) {
            a(this)
              .addClass('hided-s')
              .hide()
              .wrap("<span class='crf-s " + a(this).attr('class') + "' id='crf-s-" + c + "' />")
              .parent()
              .append("<span class='option'>" + a(this).find('option:selected').text() + '</span>');
            var d = a('<ul></ul>');
            a(this)
              .children()
              .each(function () {
                d.append(
                  "<li class='" +
                    (void 0 != a(this).attr('class') ? a(this).attr('class') + '' : '') +
